...
def convert_m_flight_to_multiflight(mflight):
    ...
    flight.others_info = others_info
...
class AgeInfo(object):
    ...
    def get_age_list(self):
        ...
        elif isinstance(self.v_age, int):  # no n_age, have v_count
            return {'Adult': [18] * self.v_age, 'Child': [], 'Infant': []}
        elif not self.v_age:  # no n_age, no v_count
            return {'Adult': [18, 18], 'Child': [], 'Infant': []}
